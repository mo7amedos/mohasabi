...
class _AddCompanyState extends State<AddCompany>{
  ...
  Widget build(BuildContext context) {
    Future<bool> _back() async {
      return await Navigator.push(context, MaterialPageRoute(builder: (context) => MyProfile()));
    }
    GlobalKey<FormState> _mycompanyformKey = GlobalKey<FormState>();
